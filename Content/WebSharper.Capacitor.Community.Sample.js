...
import { TextToSpeech as TextToSpeech_1 } from "@capacitor-community/text-to-speech"
...
function Main(){
  ...
  const L=_c_13.Convert((name) => {
    const this_3=new _c_3("New_1");
    const b_1=(this_3.h.push(new _c_11("name", name)),this_3);
  ...
  const this_2=(this_1.h.push(new _c_9("listcontainer", L)),this_1);
  const t=(this_2.h.push(new _c_8("name", newName)),this_2);
  const t_1=(t.h.push(EventQ2(t.k, "add", () => t.i, () => {
    People().Append(newName.Get());
    newName.Set("");
  })),t);
  const b=(t_1.h.push(EventQ2(t_1.k, "texttospeech", () => t_1.i, () => {
    const _3=null;
    Start(Delay(() => AsAsync(TextToSpeech().then(() => {
      const _4=(s) => {
        console.log(s);
      };
      return _4("Speak Started");
    }))), null);
  })),t_1);
...
function TextToSpeech(){
  ...
  return new Promise((_2) => {
    let r;
    _2(TextToSpeech_1.speak((r={},r.text="This is a sample text.",r.lang="en-US",r.rate=1,r.pitch=1,r.volume=1,r.category="ambient",r)).then(() => Promise.resolve(null)));
  });
}
...
let _c_4=Lazy((_i) => class ListModel extends _c {
  static {
    _c_4=_i(this);
  }
  key;
...
function EventQ2(_1, holeName, ti, f){
  return new _c_12(holeName, (el) =>(ev) => {
    const i=ti();
    i.SetAnchorRoot(el);
    return f({
      Vars:i, 
...
function CompleteHoles(key, filledHoles, vars){
  ...
  const filledVars=new _c_16("New_3");
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      const r=ty===0?_c_17.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?"":o.$0);
        return new _c_8(name, _2);
      }):ty===1?_c_17.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?0:o.$0);
        return new _c_18(name, _2);
      }):ty===2?_c_17.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?false:o.$0);
        return new _c_19(name, _2);
      }):ty===3?_c_17.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_20(name, _2);
      }):ty===4?_c_17.GetOrAddHoleFor(key, name, () => new _c_21(name, _c_1.Create_1([]))):ty===5?_c_17.GetOrAddHoleFor(key, name, () => new _c_22(name, _c_1.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_17.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?[]:o.$0);
...
let _c_6=Lazy((_i) => class Var extends _c {
  static {
    _c_6=_i(this);
  }
});
...
let _c_7=Lazy((_i) => {
  Force(_c_6);
  return class ConcreteVar extends _c_6 {
    static {
      _c_7=_i(this);
    }
    isConst;
...
function LoadNestedTemplates(root, baseName){
  ...
  const instantiated=new _c_16("New_3");
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_32.TreeNode(docTreeNode, updates):_c_13.Mk(TreeDoc(docTreeNode), updates);
}
...
function PrepareTemplateStrict(baseName, name, fakeroot, prepareLocalTemplate){
  const processedHTML5Templates=new _c_16("New_3");
        ...
        case 1:
          ...
          if(instBaseName!=""&&!LoadedTemplates().ContainsKey(instBaseName))return failNotLoaded(instName);
            ...
            if(!d.ContainsKey(instName))return failNotLoaded(instName);
              ...
              const usedHoles=new _c_16("New_3");
...
function InlineTemplate(el, fillWith){
  ...
  const tryGetAsDoc=(name) => {
    ...
    if(m[0]){
      ...
      else if(th instanceof _c_11)return Some(_c_13.TextNode(th.Value));
      else {
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_39.Concat(choose((x_1) => {
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_38?Some(Handler(get(a, 0), th.Value)):th instanceof _c_12?Some(_c_39.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
    ...
    for(let i=0, _7=holeAttrs.length-1;i<=_7;i++)((() => {
      ...
      const value=foldBack((_9, _10) =>(((t) => {
        ...
        return(t_1) => {
          ...
          return holeContent.$==1?[textBefore_1, _c_42.Cons(textAfter==""?holeContent.$0:Map_1((s_5) => s_5+textAfter, holeContent.$0), views)]:[textBefore_1+holeContent.$0+textAfter, views];
        };
      })(_9))(_10), res, [finalText, _c_42.Empty]);
      if(value[1].$==1){
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
      ...
      else _8=_c_39.Create(attrName, value[0]);
...
let _c_13=Lazy((_i) => class Doc extends _c {
  ...
  static Convert(render, view){
    return _c_13.Flatten(MapSeqCached(render, view));
  }
  ...
  static Flatten(view){
    return _c_13.EmbedView(Map_1(_c_13.Concat, view));
  }
  static get Empty(){
  ...
  static Concat(xs){
    return TreeReduce(_c_13.Empty, _c_13.Append, ofSeqNonCopying(xs));
  }
  static EmbedView(view){
    const node=CreateEmbedNode();
    return _c_13.Mk(EmbedDoc(node), Map_1(() => { }, Bind_1((doc) => {
  ...
  static Append(a, b){
    return _c_13.Mk(AppendDoc(a.docNode, b.docNode), Map2Unit_1(a.updates, b.updates));
  }
  static TextNode(v){
...
function CreateWithStorage(key, storage){
  return new _c_4("New", key, storage);
}
let _c_16=Lazy((_i) => class HashSet extends _c {
  static {
    _c_16=_i(this);
  }
  equals;
  ...
  IntersectWith(xs){
    const other=new _c_16("New_4", xs, this.equals, this.hash);
...
function distinctBy(f, s){
  return{GetEnumerator:() => {
    const o=Get(s);
    const seen=new _c_16("New_3");
    return new _c_25(null, null, (e) => {
      let cur;
      let has;
      if(o.MoveNext()){
        cur=o.Current;
...
function ofSeq(xs){
  ...
  else if(xs instanceof _c_42)return ofList(xs);
  else {
    const q=[];
    const o=Get(xs);
    try {
...
let _c_17=Lazy((_i) => class TemplateInitializer extends _c {
  static {
    _c_17=_i(this);
  }
  static init;
  ...
  static GetHolesFor(id){
    let o;
    const m=(o=null,[_c_17.initialized.TryGetValue(id, {get:() => o, set:(v) => {
      o=v;
    }}), o]);
    if(m[0])return m[1];
    else {
      const d=new _c_14("New_5");
      _c_17.initialized.set_Item(id, d);
      return d;
    }
  }
  static {
    _c_17.initialized=new _c_14("New_5");
    _c_17.instances=new _c_14("New_5");
  }
});
let _c_18=Lazy((_i) => {
  Force(_c_5);
...
function MapSeqCachedBy(key, conv, view){
  const state=[new _c_14("New_5")];
  return Map_1((xs) => {
    const prevState=state[0];
    const newState=new _c_14("New_5");
...
let _c_28=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_28=_i(this);
  }
  idle;
...
let _c_31=Lazy((_i) => class DocElemNode {
  ...
  static New(Attr, Children_1, Delimiters, El, ElKey, Render){
    ...
    return Create_2(_c_31, _2);
  }
});
function InMemory(init_2){
  return new _c_36(init_2);
}
let _c_32=Lazy((_i) => {
  Force(_c_13);
  return class Elt extends _c_13 {
    ...
    static TreeNode(tree, updates){
      const rvUpdates=_c_43.Create(updates);
...
let _c_35=Lazy((_i) => class KeyCollection extends _c {
  static {
    _c_35=_i(this);
  }
  d;
...
function BatchUpdatesEnabled(){
  return _c_45.BatchUpdatesEnabled;
}
...
let _c_36=Lazy((_i) => class ArrayStorage extends _c {
  static {
    _c_36=_i(this);
  }
  init;
...
function Static(attr){
  return _c_39.A3(attr);
}
function Dynamic(view, set_1){
  return _c_39.A1(new _c_48(view, set_1));
}
function EmptyAttr(){
  return _c_50.EmptyAttr;
}
...
function ValueWith(bind, var_1){
  const p=bind(var_1);
  return _c_39.Append(Static(p[0]), DynamicCustom(p[1], p[2]));
}
function DynamicCustom(set_1, view){
  return Dynamic(view, set_1);
}
let _c_39=Lazy((_i) => class Attr {
  static {
    _c_39=_i(this);
  }
  static Handler(event, q){
    return _c_39.HandlerImpl(event, q);
  }
  static Concat(xs){
    const x=ofSeqNonCopying(xs);
    return TreeReduce(EmptyAttr(), _c_39.Append, x);
  }
...
let _c_42=Lazy((_i) => class FSharpList {
  static {
    _c_42=_i(this);
  }
...
let _c_43=Lazy((_i) => class Updates_1 {
  static {
    _c_43=_i(this);
  }
  c;
...
let _c_44=Lazy((_i) => class ValueCollection extends _c {
  static {
    _c_44=_i(this);
  }
  d;
...
function get_Empty_1(){
  return NodeSet(new _c_16("New_3"));
}
function FindAll(doc){
  ...
  loop(doc);
  return NodeSet(new _c_16("New_2", q));
}
...
let _c_47=Lazy((_i) => class $StartupCode_Animation {
  ...
  static CubicInOut;
  static {
    this.CubicInOut=_c_51.Custom((t) => {
      const t2=t*t;
      return 3*t2-2*(t2*t);
    });
...
let _c_48=Lazy((_i) => class DynamicAttrNode extends _c {
  static {
    _c_48=_i(this);
  }
  push;
...
let _c_50=Lazy((_i) => class Client {
  static {
    _c_50=_i(this);
  }
  ...
  static {
    ...
    this.IntGetChecked=(el) => {
      ...
      let o;
      const s_8=el.value;
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_52.Blank(s_8):_c_52.Invalid(s_8);
      else {
        const m=(o=0,[TryParse(s_8, {get:() => o, set:(v) => {
          o=v;
        }}), o]);
        _1=m[0]?_c_52.Valid(m[1], s_8):_c_52.Invalid(s_8);
      }
      return Some(_1);
    };
    ...
    this.FloatGetChecked=(el) => {
      ...
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_52.Blank(s_8):_c_52.Invalid(s_8);
        ...
        const i=+s_8;
        _1=isNaN(i)?_c_52.Invalid(s_8):_c_52.Valid(i, s_8);
      }
      return Some(_1);
    };
...
let _c_51=Lazy((_i) => class Easing extends _c {
  static {
    _c_51=_i(this);
  }
  transformTime;
...
function Filter_1(ok, set_1){
  return new _c_16("New_2", filter(ok, ToArray_2(set_1)));
}
function Except_1(excluded, included){
  const set_1=new _c_16("New_2", ToArray_2(included));
...
function Intersect_1(a, b){
  const set_1=new _c_16("New_2", ToArray_2(a));
...
function StringSet(){
  return _c_50.StringSet;
}
function StringGet(){
  return _c_50.StringGet;
}
function StringListSet(){
  return _c_50.StringListSet;
}
function StringListGet(){
  return _c_50.StringListGet;
}
function DateTimeSetUnchecked(){
  return _c_50.DateTimeSetUnchecked;
}
function DateTimeGetUnchecked(){
  return _c_50.DateTimeGetUnchecked;
}
...
function FileSetUnchecked(){
  return _c_50.FileSetUnchecked;
}
function FileGetUnchecked(){
  return _c_50.FileGetUnchecked;
}
function IntSetUnchecked(){
  return _c_50.IntSetUnchecked;
}
function IntGetUnchecked(){
  return _c_50.IntGetUnchecked;
}
function IntSetChecked(){
  return _c_50.IntSetChecked;
}
function IntGetChecked(){
  return _c_50.IntGetChecked;
}
function FloatSetUnchecked(){
  return _c_50.FloatSetUnchecked;
}
function FloatGetUnchecked(){
  return _c_50.FloatGetUnchecked;
}
function FloatSetChecked(){
  return _c_50.FloatSetChecked;
}
function FloatGetChecked(){
  return _c_50.FloatGetChecked;
}
function StringApply(){
  return _c_50.StringApply;
}
function FloatApplyUnchecked(){
  return _c_50.FloatApplyUnchecked;
}
function BoolCheckedApply(){
  return _c_50.BoolCheckedApply;
}
function DateTimeApplyUnchecked(){
  return _c_50.DateTimeApplyUnchecked;
}
function FileApplyUnchecked(){
  return _c_50.FileApplyUnchecked;
}
function StringListApply(){
  return _c_50.StringListApply;
}
function isBlank(s){
  return forall_2(IsWhiteSpace, s);
}
let _c_52=Lazy((_i) => class CheckedInput {
  static {
    _c_52=_i(this);
  }
  get Input(){
...
let _c_53=Lazy((_i) => class $StartupCode_AppendList {
  static {
    _c_53=_i(this);
  }
  static Empty;
